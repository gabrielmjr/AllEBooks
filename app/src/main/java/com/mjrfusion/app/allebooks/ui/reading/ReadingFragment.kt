...
class ReadingFragment : BaseFragment(R.layout.fragment_reading), DocumentsAdapter.ClickListener {
    ...
    override fun initializeAttributes() {
        ...
        documentAdapter = DocumentsAdapter(requireContext(), ArrayList(), this)
